    ...
    return (
        <footer className={styles.footer}>
            ...
            <div className={styles.section}>
                ...
                <Link className={styles.footerLinks} to="/about-us">Somos Mahalo</Link>
                <Link className={styles.footerLinks} to="/category/balanceboard">Nuestra tienda</Link>
                <Link className={styles.footerLinks} to="/faqs">Preguntas frecuentes</Link>
            </div>
